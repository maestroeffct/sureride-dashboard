// Static ISO country + E.164 dial code list, matches the shape
// countriesnow.space used to return so useCountryDialCodes can be a
// drop-in swap. Sourced from the ITU E.164 registry / Wikipedia country
// dialing codes, cross-checked against libphonenumber. Nigeria is at
// the top so the picker defaults there for the SureRide market.
...
] satisfies ReadonlyArray<{ name: string; code: string; dialCode: string }>;
